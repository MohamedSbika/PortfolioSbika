...
const projects = [
  {
    ...
    description:
      "<p>Crud entities (product, projects, and tasks using node, express, mongo and React).</p>",
    githubLink: "https://github.com/MohamedSbika/ReactProject_Beginner_Front",
    // techno
    html: true,
    css: true,
    javascript: true,
  ...
  },
  {
    ...
    description:
      "<Also>The goal of the project is to develop a microservices architecture to manage teams and players in the context of a sports application. This architecture uses a variety of languages and technologies, including JavaScript, Protobuf, gRPC, Apache Kafka, and MongoDB. Microservices communicate with each other asynchronously to deliver optimal performance and scalability.<p/> <br/> ",
    javascript: true,
    kafka: true,
  },
  {
    ...
    heading: "Learn & Grow",
    description:
      "<p>my app Learn and Grow is a Flutter application that is used to cultivate children from 4 to 8 years old in all areas of life (sports, colors, etc.) my app contains 6 mini-apps which are: -calculator -colors (cultivate the child to know the colors) -draw (paint app) -country (API used to give the flag of each selected country) -sport(give general information about each sport) -todo (simple to do list) with a Login and register interface at the beginning to access the app (local database (SQLite)).</p>",
    githubLink: "https://github.com/MohamedSbika/ProjetEnfant",
    // techno
    flutter : true
  },
  {
    ...
    websiteLink: "https://mohamedsbika.vercel.app/",
    githubLink: "https://github.com/MohamedSbika/Portfolio",
    // techno
    html: true,
    css: true,
    javascript: true,
